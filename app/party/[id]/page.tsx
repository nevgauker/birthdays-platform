...
import { getGuestByIdAndParty } from '@/actions/guestActions' // we'll write this
import { getPartyById } from '@/actions/partyActions' // you already have this probably
...
export default function PublicPartyPage({ params }: PublicPartyPageProps) {
    ...
    const handleGuestLogin = async () => {
        ...
        const exists = await getGuestByIdAndParty(guestIdInput, params.id)
    ...
    // If authorized and party loaded
    return (
        <>
